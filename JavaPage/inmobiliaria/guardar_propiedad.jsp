...
<%
    ...
    if ("POST".equalsIgnoreCase(request.getMethod())) {
        ...
        try {
            ...
            // Insert into DB
            Connection conn = DriverManager.getConnection("jdbc:mysql://bimg5zspe3vpdruhh5sp-mysql.services.clever-cloud.com:3306/bimg5zspe3vpdruhh5sp?useSSL=false&serverTimezone=UTC&characterEncoding=UTF-8", "urqjyyyurwfqifmx", "cR0QWIrrmASKpi10R4Vy");
            ...
            if (rows > 0) {
                response.sendRedirect("propiedades.jsp?success=Propiedad agregada exitosamente");
            } else {
