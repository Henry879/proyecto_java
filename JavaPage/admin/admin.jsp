...
<head>
    ...
    <title>Panel Admin - Inmobiliaria Java</title>
</head>
<body class="d-flex flex-column h-100">
        ...
        <div class="container-fluid px-4">
            ...
            <div class="collapse navbar-collapse" id="navbarAdmin">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item"><a class="nav-link" href="<%=request.getContextPath()%>/admin/reportes.jsp">Reportes</a></li>
    ...
    <main class="flex-shrink-0">
        <div class="container px-5 my-5">
            <h2 class="fw-bolder mb-4 text-center" style="color: #23395d;">Panel de Administración</h2>
                ...
                <div class="col-md-3 mb-4">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <a href="propiedades.jsp" class="btn btn-primary">Ir a Propiedades</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 mb-4">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <p class="card-text">Ver citas solicitadas por usuarios.</p>
                            <a href="citas.jsp" class="btn btn-secondary">Ver Citas</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 mb-4">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <p class="card-text">Ver reportes de propiedades disponibles, alquiladas o vendidas.</p>
                ...
                <div class="col-md-3 mb-4">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <p class="card-text">Gestionar usuarios: agregar, editar, eliminar.</p>
                            <a href="usuarios.jsp" class="btn btn-success">Gestionar Usuarios</a>
                        </div>
                    </div>
                </div>
                <div class="col-md-3 mb-4">
                    <div class="card text-center">
                        <div class="card-body">
                            ...
                            <p class="card-text">Configurar opciones del sistema.</p>
                            <a href="configuracion.jsp" class="btn btn-warning">Ir a Configuración</a>
                        </div>
                    </div>
                </div>
            </div>
